...
# Константы модуля: regex-паттерны компилируются один раз при импорте
TAG_PATTERN = re.compile(r'<[^>]+>')
PREFIX_SPLIT_PATTERN = re.compile(r'_')
        ...
        for tag, file_path in all_tags:
            try:
                ...
                if fuzzy_val and fuzzy_path and fuzzy_path != file_path:
                    ...
                    prefix = PREFIX_SPLIT_PATTERN.split(tag, 1)[0] if '_' in tag else tag
