...
class GrammarConsistencyChecker:
    ...
    def __init__(self, lang_code="ru"):
        ...
        # Типичные окончания для проверки родов и падежей (с учетом Ё)
        self.SUFFIX_RULES = {
            'ru': {
                'mas': (['ый', 'ий', 'ой', 'ин', 'ов', 'ёй'], ['ая', 'ия', 'ое', 'ее', 'ёе']),
                'fem': (['ая', 'ия', 'ья'], ['ый', 'ий', 'ое', 'ее', 'ёе']),
                'neu': (['ое', 'ее', 'ёе'], ['ый', 'ий', 'ая', 'ия']),
                'gen': (['а', 'я', 'и', 'ы', 'ов', 'ей'], ['ый', 'ий', 'ая']),
                'dat': (['у', 'ю', 'е'], []),
                'acc': (['а', 'я', 'у', ''], []),
                'ins': (['ом', 'ым', 'ой', 'ей', 'ем', 'ям'], []),
                'prep': (['е', 'и'], [])
            },
            'uk': {
                'mas': (['ий', 'ій', 'ой', 'ин', 'ів'], ['а', 'я', 'е', 'є']),
                'fem': (['а', 'я', 'ья'], ['ий', 'ій', 'е', 'є']),
                'neu': (['е', 'є'], ['ий', 'ій', 'а', 'я']),
                'gen': (['а', 'я', 'и', 'у', 'ів', 'ей'], ['ий', 'ій', 'а']),
                'dat': (['ові', 'ю', 'еві'], []),
                'acc': (['а', 'я', ''], []),
                'ins': (['ом', 'им', 'ою', 'єю'], []),
                'prep': (['і', 'у', 'ові'], [])
        ...
        self.exceptions = {"судья", "папа", "дідусь", "чоловік", "соловей", "судья"}
