...
class TranslationStatusChecker:
    ...
    def __init__(self, mods_path: str, logger: Optional[logging.Logger] = None):
...
def check_translation_statuses(mods_path: str, logger: Optional[logging.Logger] = None) -> TranslationDependencyReport:
    """
...
def get_translation_tree(mods_path: str, logger: Optional[logging.Logger] = None) -> Dict[str, Any]:
    """
