...
NEW_KEYS = {
    ...
    "editor_translate_empty_confirm": {"ru": "Найдено {count} пустых записей. Выполнить автоперевод?", "en": "Found {count} empty entries. Perform auto-translation?", "ua": "Знайдено {count} порожніх записів. Виконати автопереклад?", "ja": "{count}件の空のレコードが見つかりました。自動翻訳を実行しますか？"},
    "editor_translate_empty_title": {"ru": "Подтверждение", "en": "Confirmation", "ua": "Підтвердження", "ja": "確認"},
