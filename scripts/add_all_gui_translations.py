...
NEW_KEYS = {
    ...
    "game_loader_select_language": {"ru": "Выбор языка", "en": "Language selection", "ua": "Вибір мови", "ja": "言語選択"},
    "game_loader_language_prompt": {"ru": "Введите язык для загрузки справочника\n(по умолчанию Russian):", "en": "Enter language for glossary load\n(default: Russian):", "ua": "Введіть мову для завантаження справочника\n(за замовчуванням: Russian):", "ja": "ガイドラインを読み込む言語を入力してください\n(デフォルト: Russian):"},
}

def main():
    print("Adding ~75 keys for gui...\n")
    ...
    for lang in languages:
        ...
        if lang_code not in data:
            print(f"Language {lang_code} not found in {lang}.json")
            continue
        ...
        print(f"OK {lang}.json: added {added} keys (total: {len(translations)})")
