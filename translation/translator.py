...
class AutoTranslator:
    ...
    def __init__(
        ...
        self.glossary_manager: GlossaryManager | None = None
    ...
    def translate(self, text: str, original_text: OptionalStr = None) -> TranslationResult:
        ...
        if self.glossary_manager:
            text_with_glossary = self.glossary_manager.apply_to_text(text)
        elif self.glossary:
            text_with_glossary = self.glossary.apply_to_text(text)
        else:
            text_with_glossary = text
        ...
        try:
            ...
            if translated:
                ...
                if hasattr(glossary_for_morphy, '_use_morphy') and glossary_for_morphy._use_morphy:
                    translated = glossary_for_morphy.apply_morphology(text_with_glossary, translated, text_with_glossary)
