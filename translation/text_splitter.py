...
def split_text(text: str, max_chars: int = 450) -> list[str]:
    ...
    # Поддерживаем латиницу (.!?), корейский/японский/китайский (。！？)
    # Защита от разрыва версий (v1.4.) и дробных чисел (0.5.):
    # разделяем только если после знака следует пробел и заглавная буква
