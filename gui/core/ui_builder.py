...
class UIBuilder:
    ...
    def build(self) -> dict:
        ...
        # Упаковываем в правильном порядке: StatusBar ПЕРВЫМ, потом PanedWindow

        # Создаём фрейм для статус-бара с компактной высотой
        status_frame = ttk.Frame(self.root)
        status_frame.pack_propagate(False)
        status_frame.configure(height=50)  # Уменьшил с 80 до 55
        ...
        status_frame.pack(side="bottom", fill="x", padx=5, pady=1)  # Уменьшил pady с 2 до 1
